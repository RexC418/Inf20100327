...
struct RandomLevelSource : ChunkSource{
	...
	std::map<uint64_t, struct LevelChunk*> field_19E0;
	Random random;
	InfdevJavaRandom infdevRandom;
	...
	RandomLevelSource(struct Level*, int64_t, int32_t, bool);
	...
	void generateInfdevTerrain(int32_t, int32_t, uint8_t*);
	void generateInfdevOre(int32_t, int32_t, int32_t, int32_t);
	void generateInfdevTree(int32_t, int32_t, int32_t);
	double initializeInfdevNoiseField(double, double, double);
