...
int64_t InfdevJavaRandom::nextLong(){const uint64_t hi=static_cast<uint32_t>(next(32));const uint64_t lo=static_cast<uint32_t>(next(32));return static_cast<int64_t>((hi<<32)|lo);}
