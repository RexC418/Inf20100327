...
// Java's (int) double narrowing conversion saturates out-of-range finite values
// to Integer.MIN_VALUE/MAX_VALUE. A plain C++ static_cast<int> is undefined for
// values such as the Far Lands coordinates used by Infdev, so reproduce Java's
// conversion explicitly before applying the 8-bit permutation mask.
